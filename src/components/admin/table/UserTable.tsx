            ...
            {(user) => {
              ...
              return (
                <UserRow
                  ...
                  isSettingPassword={props.settingPasswordUserId === user.id}
                  ...
                  onSetPasswordClick={() => props.onSetPasswordClick(user.id)}
                  onSetNewPassword={props.onSetNewPassword}
                  onConfirmSetPassword={() => props.onConfirmSetPassword(user.id)}
